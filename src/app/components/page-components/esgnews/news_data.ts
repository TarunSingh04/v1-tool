export const News_data = [
  ...
  {
    Headline:
      "CEOs Shift Focus From Sustainability to AI and Inflation, Survey Finds",
    Summary:
      "The survey, conducted globally, found that corporate concern on sustainability has made way for more time-sensitive concerns, such as AI adoption and inflation. As a result, while 81% of CEOs acknowledge the long-term significance of keeping up with sustainability efforts, only 47% are actively prioritizing it.\u00a0 This trend is largely driven by rising costs and [\u2026]\n",
    URL: "https://impakter.com/ceos-shift-focus-from-sustainability-to-ai-and-inflation-survey-finds/",
    Image_URL:
      "https://impakter.com/wp-content/uploads/2024/09/image-from-rawpixel-id-3284178-jpeg-e1726666469392.jpg",
    Date: "2024-09-18",
    Categories: ["Business", "ESG FINANCE", "ESG News"],
    Tags: [
      "AI",
      "artificial intelligence",
      "Bain &amp; Company",
  ...
  },
  {
    ...
    Image_URL:
      "https://impakter.com/wp-content/uploads/2024/08/1-PIA26411_Tanager-Rendering.jpg",
    Date: "2024-08-23",
    Categories: [
      "Business",
      "Climate Change",
  ...
  },
  {
    ...
    Summary:
      "On August 5, 2024, the US Court for the District of Columbia (DC)\u00a0decided that Google was a monopolist, meaning it has durable market power as the dominant player in its field of \u201cgeneral search services.\u201d This is a violation of competition law. As a remedy, the DC Court may seek from Google search neutrality, requiring [\u2026]\n",
    URL: "https://impakter.com/googles-monopoly-case-builds-pressure-on-tech-giants/",
    Image_URL:
      "https://impakter.com/wp-content/uploads/2024/08/74134da2-1d92-4bcf-b603-dd07fdca1253-e1723630479164.jpg",
    Date: "2024-08-14",
    Categories: ["Business", "ESG News", "TECH"],
    Tags: [
      "Amazon",
      "big tech",
      "Facebook",
  ...
  },
  {
    ...
    Image_URL:
      "https://impakter.com/wp-content/uploads/2024/08/Bank_of_Tokyo-Mitsubishi_UFJ_2018-1-e1723461141917.jpg",
    Date: "2024-08-12",
    Categories: [
      "Business",
      "Environment",
  ...
  },
  {
    ...
    Summary:
      "When Category 5 Hurricane Otis roared through Acapulco, Mexico, in October 2023, the city was left in ruins. Winds stripped facades from beachfront buildings and storm surge flooded lobbies. The storm killed at least 50 people and damaged 80% of hotels in the once-glittering resort town. Six months later, a Bloomberg reporter\u00a0described \u201ca grim scene,\u201d [\u2026]\n",
    URL: "https://impakter.com/how-much-will-climate-change-drag-down-the-economy/",
    Image_URL:
      "https://impakter.com/wp-content/uploads/2024/07/624-with-caption-Tom-Toro-YCC-We-Ran-The-Numbers-finish-6-25-24.webp",
    Date: "2024-07-21",
    Categories: [
      "Business",
      "Climate Change",
